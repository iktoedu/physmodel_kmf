...
protected:
    void preThink();
    void postThink();
    void describeIntoImplementation(std::ostream &);
...
private:
    ...
    AtomNeighbourIterator ***mvpAtomNeighbourIterators = 0;

    AtomNeighbourIterator ***allocateNeighbourIterators();
    void deallocateNeighbourIterators(AtomNeighbourIterator ***);
    AtomNeighbourIterator &getAtomNeighbourIterator(const atom_reference_2d_t &);
};
